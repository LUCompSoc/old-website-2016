<?php namespace CompSoc\Jobs\Models;
...
class Job extends Model
{
     ...
     */
    public $table = 'compsoc_job_listings';
    ...
    public static $allowedSortingOptions = array(
        ...
        'pinned desc' => 'Show pinned jobs first',
        'random' => 'Random'
    );
    ...
    public $morphMany = [];
    public $attachOne = [
        'company_logo' => ['System\Models\File']
    ];
    ...
    public function afterValidate()
    {
        if ($this->published && !$this->published_at) {
            throw new ValidationException([
               'published_at' => Lang::get('compsoc.jobs::lang.post.published_validation')
            ]);
        }
    }
    ...
    {
        return ($this->user_id == $user->id) || $user->hasAnyAccess(['compsoc.jobs.access_other_posts']);
    }
    ...
    public function scopeListFrontEnd($query, $options)
    {
        ...
        $searchableFields = ['company', 'location', 'industry', 'position', 'excerpt', 'content'];

        if ($published) {
            $query->isPublished();
        }

        $query->whereDate('deadline', '>', new DateTime('today'));
    ...
    */
    public function filterFields($fields, $context = null)
    {
        ...
        if (!$user->hasAnyAccess(["compsoc.jobs.access_publish"])) {
